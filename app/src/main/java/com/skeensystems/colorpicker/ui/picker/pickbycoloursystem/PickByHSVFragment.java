...
import com.skeensystems.colorpicker.databinding.PickByHsvBinding;

public class PickByHSVFragment extends Fragment {

    private PickByHsvBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        binding = PickByHsvBinding.inflate(inflater, container, false);
